...
* 🧠  I'm learning Desarrollo de aplicaciones Multiplataforma, with Java, SQL, HTML CSS... I'm also triying to learn the basics to start pratising with HackTheBox machines: Linux concepts, Networks and some python by my own.
